                    ...
                    >
                        <div className="tw-justify-end tw-pt-4 tw-pb-2 tw-pr-10 tw-fixed tw-z-20 tw-right-0">
                            <div className="dropdown">
                                <button className="tw-text-2xl tw-outline-none tw-text-white dropdown-toggle flx-row tw-items-center tw-bg-transparent tw-border-0 tw-shadow-none" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    {currLang.slice(0, 2).toUpperCase()}<img className="tw-pr-1 tw-ml-2" alt={currLang} src={langs[currLang]} width={20} />
                                </button>
                                <div className="dropdown-menu tw-min-w-0 tw-bg-transparent tw-border-0 tw-mt-0 tw-pt-0" aria-labelledby="dropdownMenu2">
                                    <button onClick={() => this.changeLanguage("aze")} className={`dropdown-item tw-shadow-none tw-outline-none brdr-b tw-px-2 tw-text-white tw-bg-${currLang === 'aze' ? 'red-400' : 'gray-700'} tw-cursor-pointer`} type="button">AZ<img alt="aze" src={flag_aze} className="tw-ml-2" width={20} /></button>
                                    <button onClick={() => this.changeLanguage("eng")} className={`dropdown-item tw-shadow-none tw-outline-none brdr-b tw-px-2 tw-text-white tw-bg-${currLang === 'eng' ? 'red-400' : 'gray-700'} tw-cursor-pointer`} type="button">EN<img alt="eng" src={flag_eng} className="tw-ml-2" width={20} /></button>
                                    <button onClick={() => this.changeLanguage("rus")} className={`dropdown-item tw-shadow-none tw-outline-none brdr-b tw-px-2 tw-text-white tw-bg-${currLang === 'rus' ? 'red-400' : 'gray-700'} tw-cursor-pointer`} type="button">RU<img alt="rus" src={flag_rus} className="tw-ml-2" width={20} /></button>
                                </div>
                            </div>
                            ...
                            <div className="tw-w-full tw-flex tw-flex-col tw-overflow-y-auto tw-h-full tw-bg">
                                <div className="animated slideInDown flx-row tw-items-center tw-bg-azure tw-mx-32 tw-mb-20 tw-mt-10 tw-rounded tw-border tw-border-gray-600 p-3 tw-z-10">
                                    <div className="tw-flex-1 tw-text-left tw-align-middle tw-m-auto tw-pl-40">
                                        ...
                                        <div className="tw-text-lg tw-text-gray-700 flx-row tw-items-center tw-justify-start"><Icon.FiHome className="tw-text-blue-700 mr-2" /> {t('personPlace')}</div>
                                        {/* Social medias */}
                                    ...
                                    <div className="flx-row tw-justify-center">
                                        <div className="col-sm-8 flx-row tw-text-lg tw-text-center tw-font-bold tw-text-white tw-text-shadow">
                                            ...
                                            <div className="col-sm-6 tw-pb-10 tw-h-fit-content  tw-px-4">
                                                ...
                                                <label className="tw-text-2xl tw-pt-2">{t('sometimes')}</label>
                                                <div className="row tw-justify-center">
                                ...
                                <div className="" style={{
                                    ...
                                    <div className="flx-row tw-justify-center tw-py-20">
                                        <button type="button" className={`btn btn-lg ${timeline === 'education' ? 'btn-light' : 'tw-bg-blue-300 tw-text-white'} tw-text-lg mx-1 tw-px-20 tw-py-4`} onClick={() => { this.setState({ timeline: 'education' }) }}>{t('edu')}</button>
                                        <button type="button" className={`btn btn-lg ${timeline === 'work' ? 'btn-light' : 'tw-bg-blue-300 tw-text-white'} tw-text-lg mx-1 tw-px-20 tw-py-4`} onClick={() => { this.setState({ timeline: 'work' }) }}>{t('work')}</button>
                                    </div>
                                    {timeline === "education" &&
                                            ...
                                            <div className="timeline-container timeline-left">
                                                <div className="timeline-content">
                                                    <div className="tw-flex tw-items-center">
                                                        ...
                                                        <img src={school15} alt="" className="tw-w-14 tw-h-14 tw-rounded tw-ml-2" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="timeline-container timeline-right">
                                                <div className="timeline-content">
                                                    <div className="tw-flex tw-items-center">
                                                        ...
                                                        <img src={school44} alt="" className="tw-w-14 tw-h-14 tw-rounded tw-ml-2" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="timeline-container timeline-left">
                                            ...
                                            <div className="timeline-container timeline-right">
                                                <div className="timeline-content">
                                                    <div className="tw-flex tw-items-center">
                                                        ...
                                                        <img src={unec} alt="" className="tw-w-14 tw-h-14 tw-rounded tw-ml-2" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="timeline-container timeline-left">
                                                <div className="timeline-content">
                                                    <div className="tw-flex tw-items-center">
                                                        ...
                                                        <img src={adnsu} alt="" className="tw-w-14 tw-h-12 tw-rounded tw-ml-2" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div className="timeline-container timeline-left">
                                                <div className="timeline-content">
                                                    <div className="tw-flex tw-items-center">
                                                        ...
                                                        <img src={itmim} alt="" className="tw-w-14 tw-h-14 tw-rounded tw-ml-2" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="timeline-container timeline-right">
                                                <div className="timeline-content">
                                                    <div className="tw-flex tw-items-center">
                                                        ...
                                                        <img src={dsx} alt="" className="tw-w-14 tw-h-14 tw-rounded tw-ml-2" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="timeline-container timeline-left">
