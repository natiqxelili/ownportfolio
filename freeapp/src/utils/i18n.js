...
const resources = {
    eng: {
        translation: {
            ...
            "personProfession": "Middle Full-Stack Web Developer (Node, React, Asp.net)",
    ...
    aze: {
        translation: {
            ...
            "personProfession": "Proqram təminatı üzrə mühəndis-proqramlaşdırıcısı (Node, React, Asp.net)",
    ...
    rus: {
        translation: {
            ...
            "personProfession": "Средний веб-разработчик полного стека (Node, React, Asp.net)",
            ...
            "adnsu": "Азербайджанский Государственный Университет Нефти и Промышленности",
